<template>
  <el-dialog title="添加海克斯" width="50%" center :model-value="centerDialogVisible" @closed="closeDialog(false)">
    <!-- 用户表单 -->
    <el-form
      :model="addForm"
      :rules="addFormRules"
    ...
    >
      <el-form-item label="海克斯ID" prop="hexId">
        <el-input v-model.number="addForm.hexId"></el-input>
      </el-form-item>
      ...
      <el-form-item label="海克斯效果" prop="description">
        <el-input v-model="addForm.description" :rows="2" type="textarea"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-image :src="addForm.imgUrl" style="width: 64px" />
      </el-form-item>
    </el-form>
    <template #footer>
