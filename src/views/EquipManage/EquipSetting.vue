  ...
  <div class="setting-container">
    ...
    <div class="top">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/equip-manage/setting' }">装备管理</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/equip-manage/setting' }"></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="card">
      <el-card>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-input placeholder="搜索装备" :prefix-icon="Search" v-model="searchContent" />
          </el-col>
          <el-col :span="4">
